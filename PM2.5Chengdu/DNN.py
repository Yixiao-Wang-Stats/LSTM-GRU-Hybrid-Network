...
# 训练模型
model.fit(train_X, train_y, epochs=1000, batch_size=24, validation_data=(test_X, test_y), verbose=2)

# 预测
yhat = model.predict(test_X)

# 逆缩放
inv_yhat = np.concatenate((test_X[:, N_STEP * len(data_deal.columns):], yhat), axis=1)
